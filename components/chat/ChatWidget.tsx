...
// =============================================================================
// ChatWidget — WhatsApp-Style Chat Orchestrator
// =============================================================================
        ...
        return (
          <div className="space-y-2">
            ...
            <button
              ...
              style={{ backgroundColor: "#2EC4A5", color: "#fff" }}
            >
              {selections.addons.length > 0 ? "Continue" : "Skip"}
            </button>
          </div>
        );
      case "pickup":
      ...
      case "submitted":
        return (
          ...
          >
            ...
            <p className="text-[10px] text-white/30 text-center">or</p>
            <button
              type="button"
              onClick={handleReset}
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-[#2EC4A5] leading-tight">
            {isTyping
              ? "typing..."
              : `online \u2022 replies in ${BUSINESS.responseTime}`}
          </p>
        </div>
